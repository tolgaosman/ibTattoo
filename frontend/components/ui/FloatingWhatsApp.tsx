...
export function FloatingWhatsApp({ phone = WHATSAPP_PHONE }: { phone?: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 ring-1 ring-white/10 transition-transform duration-300 hover:scale-110 active:scale-95 sm:bottom-8 sm:right-8"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
